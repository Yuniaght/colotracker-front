...
export const registrationFields = {
  ...
  avatar: zod.array(zod.file().max(maxSize, "Fichier trop volumineux. Limite : 512Ko").mime(allowedTypes, "Type incorrect. Type authorisé : Jpg, Png, Jpeg, WebP")).max(maxFiles, "Pas plus d'un fichier").optional()
}
