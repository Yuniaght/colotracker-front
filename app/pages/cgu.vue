...
<template>
  ...
  <section class="responsive-layout responsive-padding-x responsive-padding-b pt-4">
    <p class="text-sm">Mis à jour le : <nuxt-time :datetime="data?.update_date" year="numeric" month="long" day="numeric"/>. Version : {{ data.version }}. <span @click="isConsentGiven = false" class="cursor-pointer select-none">Préférence en matière de cookie</span></p>
  </section>
</template>
<style scoped>
</style>