...
<template>
  ...
  <section class="responsive-layout responsive-padding-x responsive-padding-b pt-4">
    <p class="text-sm">Mis à jour le : <nuxt-time :datetime="data?.update_date" />. Version : {{ data.version }}. <span @click="console.log('cookies')" class="cursor-pointer select-none">Préférence en matière de cookie</span></p>
  </section>
</template>
<style scoped>
</style>